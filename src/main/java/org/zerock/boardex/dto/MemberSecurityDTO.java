...
@Setter
@ToString
//User 객체는 스프링 프레임워크에서 지원하는 사용자 객체임 username, password, authorities
public class MemberSecurityDTO extends User implements OAuth2User {
    ...
    //생성자로 멤버변수 초기화
    //Collection <> : 객체의 집합, 순서가 있는 배열공간(List), 집합체 저장공간(Set), 키와 값으로 데이터 구성하는 공간(Map)
